...
def get_special_groups(mol):
    ...
    group_templates += [
        ...
        (range(19), '[#6]-[#8][Si]([#6]-1=[#6]-[#6]=[#6]-[#6]=[#6]-1)([#6]-1=[#6]-[#6]=[#6]-[#6]=[#6]-1)C([#6])([#6])[#6]'), #t-Butyldiphenylsilyl ether
        (range(9), '[#6]-[#8][Si]([#6])([#6])C([#6])([#6])[#6]'), #t-Butyldimethylsilyl ether
        (range(20), '[#6]-[#6]-[#8][Si]([#6]-[#6]-[#6]-c1ccc(-[#6])cc1)([#6](-[#6])-[#6])[#6](-[#6])-[#6]'), #propyl-p-toluenediisopropylsilyl ether
        ...
        (range(15), '[#6]-[#6]-[#6](-[#6]-[#6])-[#6]C1([#6]-[#6]-[#6]-[#6]-[#6]1)[#6](-[#16])=O'), #S-Carbonyl deprotection (thioester)
